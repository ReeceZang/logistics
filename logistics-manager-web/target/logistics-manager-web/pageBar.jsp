...
<!--        <div class="pagin"> -->
<%--     	<div class="message">共<i class="blue">${pageModel.total }</i>条记录，当前显示第&nbsp;<i class="blue">${pageModel.pageNum }&nbsp;</i>页 --%>
<!--   	      每页 -->
<!--       <select name="pageSize" onchange="changePageSize(this.value)" style="width: 50px;"> -->
<%--           <option value="5" ${pageModel.pageSize==5?"selected":"" }>5</option> --%>
<%--           <option value="10"  ${pageModel.pageSize==10?"selected":"" }>10</option> --%>
...
<!--       </div> -->
<!--         <ul class="paginList"> -->
<!--         <li class="paginItem"><a href="javascript:homePage();"><span >首页</span></a></li> -->
<!--         <li class="paginItem"><a href="javascript:frontPage();"><span class="pagepre"></span></a></li> -->
<!--         <li class="paginItem"><a href="javascript:;">1</a></li> -->
<!--         <li class="paginItem"><a href="javascript:nextPage();"><span class="pagenxt"></span></a></li> -->
