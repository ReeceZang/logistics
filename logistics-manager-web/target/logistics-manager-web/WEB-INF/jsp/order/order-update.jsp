                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select name="transMethodId">
                                <c:forEach items="${transfer }" var="ts">
                                    <option value="${ts.baseId }">${ts.baseName }</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="takeMethodId">
                                <c:forEach items="${getMethods}" var="method">
                                    <option value="${method.baseId }">${method.baseName }</option>
                                </c:forEach>
                            </select>
                        </td>
      ...
      var index = 0;
         $(function(){
            ...
            function changeInterval(customerId){
                // 获取客户对应的baseId
                $.get("/customer/queryBaseIdByCustomerId.action",{"customerId":customerId},
                	function(baseId){
                    // 设置区间的默认选项
